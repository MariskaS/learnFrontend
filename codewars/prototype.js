...
// сделать собственную реализацию map и поместить
// в наследник класса Array (написать функцию inherit). Использовать es3.
...
function inherit(child, parent) {
    // https://habr.com/ru/post/15444/
}

console.log(inherit(MyArray, Array))
